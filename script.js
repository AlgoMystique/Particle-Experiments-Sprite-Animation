...
constructor (effect){
    ...
    this.x = this.imageSize + Math.random() * (this.effect.width  +
        this.effect.maxDistance * 4);
...
context.drawImage(this.image, this.x - this.halfImageSize, this.y - this.halfImageSize,
